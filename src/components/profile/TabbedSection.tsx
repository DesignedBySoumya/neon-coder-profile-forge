...
const tabContent = {
  Overview: [
    { type: 'submission', title: 'Two Sum - Solved', time: '2 hours ago', difficulty: 'Easy' },
    { type: 'achievement', title: 'Earned "Speed Demon" badge', time: '1 day ago' },
    { type: 'contest', title: 'Participated in Weekly Contest 321', time: '3 days ago', rank: '#142' }
  ],
  Solutions: [
    { title: 'Binary Tree Inorder Traversal', language: 'Python', likes: 23, time: '1 day ago' },
    { title: 'Merge Two Sorted Lists', language: 'JavaScript', likes: 45, time: '3 days ago' },
    { title: 'Valid Parentheses', language: 'C++', likes: 67, time: '1 week ago' }
  ],
  Discussions: [
    { title: 'Best approach for dynamic programming?', replies: 12, time: '2 days ago' },
    { title: 'Time complexity analysis help needed', replies: 5, time: '4 days ago' },
    { title: 'Interview preparation strategies', replies: 28, time: '1 week ago' }
  ],
  Projects: [
    { title: 'AI Code Reviewer', tech: 'React, Node.js, OpenAI', stars: 234, status: 'Active' },
    { title: 'Leetcode Analytics Dashboard', tech: 'Vue.js, Python', stars: 89, status: 'Completed' },
    { title: 'Algorithm Visualizer', tech: 'D3.js, TypeScript', stars: 156, status: 'In Progress' }
  ]
};
